...
var_input = ['./3c438_b/*.fits', './3c438_c/*.fits']
var_output = './3c438_out' # Path to directory for the output images
var_region = ['3c438_b.crtf', '3c438_c.crtf']

var_reftype = 0 # Choose if we should a reference point set by a predefined image (0), a fixed value (1), or the mean (2) 
var_refimage = 1 # Choose which image to align to. Only used if var_reftype = 0
